...
do
   echo "$i"
   docker build -t "thelittlefireman/docker-android-sdk:$i" --build-arg ANDROID_VERSION=$i --build-arg ANDROID_BUILD_TOOLS_VERSION=${android_build_tool_version[$index]} .
